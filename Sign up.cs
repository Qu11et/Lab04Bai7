...
namespace Lab04Bai7
{
    public partial class Sign_up : Form
    {
        ...
        {
            if (comboBox2.SelectedItem != null && comboBox2.SelectedItem.ToString() == "Male")
            {
                a = "1";
            }
            else
            ...
            var userData = new
            {
                ...
                language = comboBox1.SelectedItem != null ? comboBox1.SelectedItem.ToString() : "DefaultLanguage",
                phone = txtphone.Text
            };

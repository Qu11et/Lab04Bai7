...
{
    public partial class MailReceivve : Form
    {
        ...
        private void RenderMails(SearchQuery searchQuery = null, string CacheKey = "")
        {
            if (searchQuery == null)
            {
        ...
        //    else
        //    {
        //        frmCompose = new Compose(mailRepository, to, cc, bcc);
        //        frmCompose.TopMost = true;
        //        frmCompose.Show();
        //    }
        //}
        public MailReceivve(MailRepository mailRepository)
        {
            InitializeComponent();
